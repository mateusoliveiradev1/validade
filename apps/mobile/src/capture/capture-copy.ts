...
export const captureCopy = {
  ...
  categoryPrompt: "Escolha uma categoria do catalogo geral para localizar o produto.",
  categoryEmpty: "Catalogo geral de categorias ainda nao carregado neste aparelho.",
