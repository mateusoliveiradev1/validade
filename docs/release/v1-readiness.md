...
| Phase 12 build identity metadata       | Configured in repo | `apps/mobile/app.json`, package metadata, and build-info tests expose `0.12.0`, Android `versionCode` `120`, staging env, and `phase-12-staging-apk-120`.                                                                                                                                                | Enables compatibility checks, but does not prove a device installed the APK.                   |
