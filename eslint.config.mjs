      ...
      parserOptions: {
        projectService: {
          allowDefaultProject: [
            ...
            "apps/mobile/src/capture/device-identity.test.ts",
            ...
            "apps/mobile/src/capture/barcode-lookup-assistant.test.tsx",
            ...
            "apps/mobile/src/capture/http-sync-transport.test.ts",
          ...
          maximumDefaultProjectFileMatchCount_THIS_WILL_SLOW_DOWN_LINTING: 108,
        },
